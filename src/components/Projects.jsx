  ...
  return (
    <div className="flex flex-col text-textPrimary bg-gray-100 items-start space-y-4 p-6 rounded-3xl shadow-md">
      ...
      <p className="text-lg">
        ...
        Computer Engineering student from Évora, Portugal, currently pursuing my{" "}
        <FontAwesomeIcon icon={faComputer} /> Engineering degree at the{" "}
        <strong>NOVA University of Lisbon</strong>. Alongside my studies, I work
        as a <strong>Full-Stack Mobile and Web Software Developer</strong> at{" "}
        <strong>
          Associação In-Nova - Consultoria Júnior da Nova School of Science and
          Technology
        </strong>
        .
      </p>
      <p className="text-lg">
        ...
        inspiration in <strong>sailing</strong>, <strong>debating</strong>, and
        constantly seeking new challenges that push me to grow both personally
        and professionally.
      </p>
      <p className="text-lg">
        ...
        my playful touch—I believe every great detail has the power to delight.
      </p>
    </div>
  );
};
